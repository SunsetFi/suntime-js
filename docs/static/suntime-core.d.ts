...
declare function BreakCompletion(
  target?: string | null,
  value?: StaticJsValue | null,
): BreakCompletion;
declare function ContinueCompletion(
  target?: string | null,
  value?: StaticJsValue | null,
): ContinueCompletion;
...
export declare const AllHostAccessStubTypes: readonly ["array", "error", "promise"];
 ...
 */
export declare const synchronousDefaultTaskRunner: StaticJsTaskRunner;
/**
 * Types of allocations that may be made of the StaticJsMemoryManager.
 */
export declare enum StaticJsMemoryAllocationTag {
  /**
...
export declare function EvaluationGenerator<T>(
  maybe: MaybeEvaluationGenerator<T>,
): EvaluationGenerator<T>;
export declare function createTaskIteratorProxy(
  inner: StaticJsTaskIterator,
  { next, throw: throwFn, abort, done }: StaticJsTaskIteratorProxyOptions,
): StaticJsTaskIterator;
export declare function createTimeBoundTaskRunner({
  maxRunTime,
  maxTaskTime,
}?: TimeBoundTaskRunnerOptions): StaticJsTaskRunner;
export declare function createTimeSharingTaskRunner({
 ...
 * @public
 */
export declare function evaluateExpressionSync(
  expression: string,
  opts?: EvaluationOptions,
): unknown;
/**
 ...
 * @public
 */
export declare function evaluateModule(
  code: string,
  opts?: EvaluationOptions,
...
export declare function isStaticJsDataPropertyDescriptor(
  value: StaticJsPropertyDescriptor,
...
export declare function isStaticJsGenericPropertyDescriptor(value: unknown): value is Pick<
...
export declare function isStaticJsModuleImplementation(
  x: unknown,
...
export declare function propertyDescriptorToNative(
  descriptor: StaticJsPropertyDescriptor,
  realm: StaticJsRealm,
  access?: HostAccessArg,
): PropertyDescriptor;
export declare function propertyDescriptorToStaticJsObject(
...
export declare function staticJsModuleToImplementation(
  realm: StaticJsRealm,
  module: StaticJsModule,
): StaticJsModuleImplementation;
export declare function staticJsPrivateElementAccessor(
...
export declare namespace EvaluationGenerator {
...
type StaticJsRealmEvaluateScriptSyncOptions = Omit<
