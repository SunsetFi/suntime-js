  ...
  describe("Operators", () => {
    ...
    it("Supports multiplication", () => {
      const code = `
        2 * 3;
      `;
      expect(evaluateProgram(code)).toBe(6);
    });
    ...
    it("Supports exponentiation", () => {
      const code = `
        2 ** 3;
      `;
      expect(evaluateProgram(code)).toBe(8);
    });
    ...
    it("Supports shift left", () => {
      const code = `
        1 << 2;
      `;
      expect(evaluateProgram(code)).toBe(4);
    });
    ...
    it("Supports unsigned shift right", () => {
      const code = `
        -4 >>> 2;
      `;
      expect(evaluateProgram(code)).toBe(1073741823);
    });
  });
  ...
  describe("Boxing", () => {
    it("Supports toFixed", () => {
      const code = `
        (1.234).toFixed(2);
      `;
      expect(evaluateProgram(code)).toBe("1.23");
    });
    ...
    it("Supports toPrecision", () => {
      const code = `
        (1.234).toPrecision(2);
      `;
      expect(evaluateProgram(code)).toBe("1.2");
    });
    ...
    it("Supports toExponential", () => {
      ...
      `;
      expect(evaluateProgram(code)).toBe("1.23e+3");
    });
  });
});
