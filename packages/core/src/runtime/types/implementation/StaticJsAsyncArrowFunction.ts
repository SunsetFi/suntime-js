...
import { type StaticJsAstFunctionArgumentDeclaration } from "./StaticJsAstFunction.js";
import StaticJsAsyncDeclFunction from "./StaticJsAsyncDeclFunction.js";

export default class StaticJsArrowFunction extends StaticJsAsyncDeclFunction {
  constructor(
    realm: StaticJsRealm,
    name: string | null,
