...
export function* populatePromisePrototype(realm: StaticJsRealm, promiseProto: StaticJsObject) {
  yield* applyIntrinsicProperties(realm, promiseProto, declarations);
}
