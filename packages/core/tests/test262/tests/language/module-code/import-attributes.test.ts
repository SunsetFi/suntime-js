...
it(
  ...
  { tags: ["known-failing"] },
  createTestHandler("language/module-code/import-attributes/import-attribute-key-string-double.js"),
);

it(
  "import-attribute-key-string-single.js",
  { tags: ["known-failing"] },
  createTestHandler("language/module-code/import-attributes/import-attribute-key-string-single.js"),
);
