...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/statements/async-function/array-destructuring-param-strict-body.js"),
);
...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/statements/async-function/await-as-identifier-reference-escaped.js"),
);
...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/statements/async-function/early-errors-declaration-NSPL-with-USD.js"),
);
...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/statements/async-function/object-destructuring-param-strict-body.js"),
);
...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/statements/async-function/rest-params-trailing-comma-early-error.js"),
);
...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/statements/async-function/returns-async-arrow-returns-newtarget.js"),
);
...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/statements/async-function/syntax-declaration-no-line-terminator.js"),
);
