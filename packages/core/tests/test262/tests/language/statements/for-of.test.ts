...
describe("for-of", () => {
  ...
  it("map.js", { tags: ["known-failing"] }, createTestHandler("language/statements/for-of/map.js"));
  it(
    "nested.js",
    { tags: ["known-failing"] },
  ...
  it("set.js", { tags: ["known-failing"] }, createTestHandler("language/statements/for-of/set.js"));
  it(
