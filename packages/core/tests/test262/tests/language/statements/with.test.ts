...
describe("with", () => {
  ...
  it.skip("set-mutable-binding-binding-deleted-with-typed-array-in-proto-chain-strict-mode.js", () => {
    /* Ignored Test */
  });
  it.skip("set-mutable-binding-binding-deleted-with-typed-array-in-proto-chain.js", () => {
    /* Ignored Test */
  });
  it(
