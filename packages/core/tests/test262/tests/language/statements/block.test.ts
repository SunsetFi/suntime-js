...
it("tco-stmt-list.js", createTestHandler("language/statements/block/tco-stmt-list.js"));
it("tco-stmt.js", createTestHandler("language/statements/block/tco-stmt.js"));
});
