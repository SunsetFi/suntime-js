...
describe("errors", () => {
  ...
  describe("module-throws", () => {
    ...
    it(
      ...
      { tags: ["known-failing"] },
      createTestHandler("language/import/import-defer/errors/module-throws/trigger-evaluation.js"),
    );
  });
...
describe("evaluation-triggers", () => {
  ...
  it(
    ...
    { tags: ["known-failing"] },
    createTestHandler("language/import/import-defer/evaluation-triggers/ignore-getPrototypeOf.js"),
  );
  it(
  ...
  it(
    ...
    { tags: ["known-failing"] },
    createTestHandler("language/import/import-defer/evaluation-triggers/ignore-setPrototypeOf.js"),
  );
  it(
...
describe("syntax", () => {
  ...
  it(
    ...
    { tags: ["known-passing"] },
    createTestHandler("language/import/import-defer/syntax/invalid-default-and-defer-namespace.js"),
  );
  it(
  ...
  it(
    ...
    { tags: ["known-passing"] },
    createTestHandler("language/import/import-defer/syntax/invalid-defer-default-and-namespace.js"),
  );
  it(
