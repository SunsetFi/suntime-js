...
describe("method", () => {
  ...
  it(
    ...
    { tags: ["known-passing"] },
    createTestHandler("language/computed-property-names/class/method/constructor-can-be-getter.js"),
  );
  it(
    "constructor-can-be-setter.js",
    { tags: ["known-passing"] },
    createTestHandler("language/computed-property-names/class/method/constructor-can-be-setter.js"),
  );
  it(
