...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/expressions/async-function/await-as-identifier-reference-escaped.js"),
);
...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/expressions/async-function/early-errors-expression-NSPL-with-USD.js"),
);
...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/expressions/async-function/named-params-trailing-comma-multiple.js"),
);
...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("language/expressions/async-function/nameless-params-trailing-comma-single.js"),
);
