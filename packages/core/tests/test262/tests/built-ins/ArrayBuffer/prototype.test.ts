...
describe("slice", () => {
  it(
    ...
    { tags: ["known-failing"] },
    createTestHandler("built-ins/ArrayBuffer/prototype/slice/context-is-not-arraybuffer-object.js"),
  );
  it(
  ...
  it(
    ...
    { tags: ["known-failing"] },
    createTestHandler("built-ins/ArrayBuffer/prototype/slice/species-constructor-is-not-object.js"),
  );
  it(
    "species-constructor-is-undefined.js",
    { tags: ["known-failing"] },
    createTestHandler("built-ins/ArrayBuffer/prototype/slice/species-constructor-is-undefined.js"),
  );
  it(
  ...
  it(
    ...
    { tags: ["known-failing"] },
    createTestHandler("built-ins/ArrayBuffer/prototype/slice/species-returns-same-arraybuffer.js"),
  );
  it(
...
describe("transfer", () => {
  ...
  it(
    ...
    { tags: ["known-failing"] },
    createTestHandler("built-ins/ArrayBuffer/prototype/transfer/this-is-immutable-arraybuffer.js"),
  );
  it(
    "this-is-not-arraybuffer-object.js",
    { tags: ["known-failing"] },
    createTestHandler("built-ins/ArrayBuffer/prototype/transfer/this-is-not-arraybuffer-object.js"),
  );
  it(
    "this-is-not-object.js",
    { tags: ["known-failing"] },
...
describe("transferToFixedLength", () => {
  ...
  it(
    "this-is-detached.js",
    { tags: ["known-failing"] },
    createTestHandler("built-ins/ArrayBuffer/prototype/transferToFixedLength/this-is-detached.js"),
  );
  it(
    "this-is-immutable-arraybuffer.js",
    { tags: ["known-failing"] },
