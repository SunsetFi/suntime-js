...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("built-ins/Proxy/getOwnPropertyDescriptor/resultdesc-is-invalid-descriptor.js"),
);
...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("built-ins/Proxy/getOwnPropertyDescriptor/trap-is-missing-target-is-proxy.js"),
);
