...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("built-ins/Reflect/setPrototypeOf/proto-is-not-object-and-not-null-throws.js"),
);
...
it(
  ...
  { tags: ["known-failing"] },
  createTestHandler("built-ins/Reflect/setPrototypeOf/return-false-if-target-is-not-extensible.js"),
);
