...
describe("has", () => {
  it("has.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Reflect/has/has.js"));
  it(
    "length.js",
    { tags: ["known-failing"] },
    createTestHandler("built-ins/Reflect/has/length.js"),
  );
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Reflect/has/name.js"));
  it(
