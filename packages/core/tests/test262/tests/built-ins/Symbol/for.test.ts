...
describe("for", () => {
  ...
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Symbol/for/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Symbol/for/name.js"));
  it(
