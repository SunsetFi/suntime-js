...
it(
  ...
  { tags: ["known-passing"] },
  createTestHandler("built-ins/Promise/any/invoke-resolve-on-values-every-iteration-of-custom.js"),
);

it(
  "invoke-resolve-on-values-every-iteration-of-promise.js",
  { tags: ["known-passing"] },
  createTestHandler("built-ins/Promise/any/invoke-resolve-on-values-every-iteration-of-promise.js"),
);
...
it("length.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Promise/any/length.js"));

it("name.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Promise/any/name.js"));
