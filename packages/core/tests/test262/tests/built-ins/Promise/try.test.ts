...
it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Promise/try/length.js"));
...
it("throws.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Promise/try/throws.js"));
