...
describe("evaluate", () => {
  ...
  it(
    ...
    { tags: ["known-failing"] },
    createTestHandler("built-ins/ShadowRealm/prototype/evaluate/returns-proxy-callable-object.js"),
  );
  it(
  ...
  it(
    ...
    { tags: ["known-failing"] },
    createTestHandler("built-ins/ShadowRealm/prototype/evaluate/throws-typeerror-wrap-throwing.js"),
  );
  it(
