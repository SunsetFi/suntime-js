...
describe("trunc", () => {
  ...
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/trunc/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/trunc/name.js"));
  it(
