...
describe("log10", () => {
  ...
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/log10/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/log10/name.js"));
  it(
