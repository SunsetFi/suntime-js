...
describe("abs", () => {
  ...
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/abs/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/abs/name.js"));
  it(
