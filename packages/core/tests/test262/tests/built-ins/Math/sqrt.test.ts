...
describe("sqrt", () => {
  ...
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/sqrt/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/sqrt/name.js"));
  it(
