...
it("length.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Math/log/length.js"));

it("name.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Math/log/name.js"));
