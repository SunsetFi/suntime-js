...
describe("exp", () => {
  ...
  it("length.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Math/exp/length.js"));
  it("name.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Math/exp/name.js"));
  it(
