...
describe("max", () => {
  ...
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/max/name.js"));
  it(
  ...
  it("zeros.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/max/zeros.js"));
});
