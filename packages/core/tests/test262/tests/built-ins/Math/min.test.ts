...
describe("min", () => {
  ...
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/min/name.js"));
  it(
  ...
  it("zeros.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/min/zeros.js"));
});
