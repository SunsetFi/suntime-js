...
describe("acosh", () => {
  ...
  it("length.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Math/acosh/length.js"));
  it("name.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Math/acosh/name.js"));
  it(
    "nan-returns.js",
    { tags: ["known-passing"] },
