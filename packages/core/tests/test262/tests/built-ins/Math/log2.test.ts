...
describe("log2", () => {
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/log2/length.js"));
  it(
    "log2-basicTests.js",
    { tags: ["known-failing"] },
    createTestHandler("built-ins/Math/log2/log2-basicTests.js"),
  );
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/log2/name.js"));
  it(
