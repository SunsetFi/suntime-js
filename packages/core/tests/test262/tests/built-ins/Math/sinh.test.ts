...
describe("sinh", () => {
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/sinh/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/sinh/name.js"));
  it(
