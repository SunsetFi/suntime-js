...
describe("clz32", () => {
  ...
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/clz32/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/clz32/name.js"));
  it("nan.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/clz32/nan.js"));
  it(
