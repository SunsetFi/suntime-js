...
describe("tan", () => {
  ...
  it("length.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Math/tan/length.js"));
  it("name.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Math/tan/name.js"));
  it(
