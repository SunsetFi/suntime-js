...
describe("sin", () => {
  ...
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/sin/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/sin/name.js"));
  it(
  ...
  it("zero.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/sin/zero.js"));
});
