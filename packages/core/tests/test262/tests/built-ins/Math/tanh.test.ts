...
describe("tanh", () => {
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/tanh/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/tanh/name.js"));
  it(
