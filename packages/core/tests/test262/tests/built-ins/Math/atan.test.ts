...
describe("atan", () => {
  ...
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/atan/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Math/atan/name.js"));
  it(
