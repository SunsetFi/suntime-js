...
it("length.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Math/floor/length.js"));

it("name.js", { tags: ["known-passing"] }, createTestHandler("built-ins/Math/floor/name.js"));
