...
it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Array/fromAsync/name.js"));

it(
  "non-iterable-input-does-not-use-array-prototype.js",
  { tags: ["known-failing"] },
  createTestHandler("built-ins/Array/fromAsync/non-iterable-input-does-not-use-array-prototype.js"),
);
