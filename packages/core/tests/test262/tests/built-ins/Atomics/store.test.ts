...
describe("store", () => {
  ...
  it(
    "descriptor.js",
    { tags: ["known-failing"] },
    createTestHandler("built-ins/Atomics/store/descriptor.js"),
  );
  it.skip("expected-return-value-negative-zero.js", () => {
    /* Ignored Test */
  });
  ...
  it(
    "length.js",
    { tags: ["known-failing"] },
    createTestHandler("built-ins/Atomics/store/length.js"),
  );
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Atomics/store/name.js"));
  it.skip("non-shared-bufferdata.js", () => {
    /* Ignored Test */
  });
