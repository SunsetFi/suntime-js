...
it(
  "descriptor.js",
  { tags: ["known-failing"] },
  createTestHandler("built-ins/Atomics/sub/descriptor.js"),
);
...
it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Atomics/sub/length.js"));

it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Atomics/sub/name.js"));
