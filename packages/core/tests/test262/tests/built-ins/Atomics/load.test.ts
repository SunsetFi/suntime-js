...
it(
  "descriptor.js",
  { tags: ["known-failing"] },
  createTestHandler("built-ins/Atomics/load/descriptor.js"),
);
...
it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Atomics/load/length.js"));

it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Atomics/load/name.js"));
