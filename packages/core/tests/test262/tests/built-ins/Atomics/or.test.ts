...
describe("or", () => {
  ...
  it(
    "descriptor.js",
    { tags: ["known-failing"] },
    createTestHandler("built-ins/Atomics/or/descriptor.js"),
  );
  ...
  it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Atomics/or/length.js"));
  it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Atomics/or/name.js"));
  it.skip("non-shared-bufferdata.js", () => {
    /* Ignored Test */
  });
