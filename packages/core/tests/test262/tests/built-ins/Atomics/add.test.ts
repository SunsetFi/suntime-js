...
it(
  "descriptor.js",
  { tags: ["known-failing"] },
  createTestHandler("built-ins/Atomics/add/descriptor.js"),
);
...
it("length.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Atomics/add/length.js"));

it("name.js", { tags: ["known-failing"] }, createTestHandler("built-ins/Atomics/add/name.js"));
