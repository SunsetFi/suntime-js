...
it(
  ...
  { tags: ["known-failing"] },
  createTestHandler("built-ins/RegExpStringIteratorPrototype/next/custom-regexpexec-get-throws.js"),
);
...
it(
  ...
  { tags: ["known-failing"] },
  createTestHandler("built-ins/RegExpStringIteratorPrototype/next/next-missing-internal-slots.js"),
);
